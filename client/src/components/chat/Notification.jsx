...
const Notification = () => {
    ...
    const { notifications, markAllNotificationsAsRead, allUsers, userChats, markNotificationAsRead } = useContext(ChatContext);
            ...
            {isOpen ? <div className="notifications-box">
                ...
                {modifiedNotifications && modifiedNotifications.map((n, index) => {
                    return (<div key={index} className={n.isRead ? "notification" : "notification not-read"} onClick={() => {
                        markNotificationAsRead(n, user, notifications, userChats);
                        setIsOpen(false);
                    }}>

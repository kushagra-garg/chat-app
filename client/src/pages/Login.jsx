            ...
            <Form onSubmit={loginUser}>
                <Row style={{
                    ...
                    <Col xs={6}>
                        <Stack gap={3}>
                            <h2>Login</h2>
                            <FormControl type="email" placeholder="Email" onChange={(e) => updateLoginInfo({
                                ...loginInfo, email: e.target.value
                            })} />
                            <FormControl type="password" placeholder="Password" onChange={(e) => updateLoginInfo({
                                ...loginInfo, password: e.target.value
                            })} />
                            <Button variant="primary" type="submit">
                                {isLoginLoading ? "wait...." : "Login"}
                            </Button>
                            {
